...
curl -sSL https://raw.githubusercontent.com/xiangking/sub2api-kiro/main/deploy/docker-deploy.sh -o docker-deploy.sh
...
```bash
curl -sSL https://raw.githubusercontent.com/xiangking/sub2api-kiro/main/deploy/install.sh | sudo bash
```

### Manual Installation

1. Download the latest release from [GitHub Releases](https://github.com/xiangking/sub2api-kiro/releases)

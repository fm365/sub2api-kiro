...
func init() {
	...
	groupDescPeakRateEnabled := groupFields[17].Descriptor()
	...
	groupDescPeakStart := groupFields[18].Descriptor()
	...
	groupDescPeakEnd := groupFields[19].Descriptor()
	...
	groupDescPeakRateMultiplier := groupFields[20].Descriptor()

export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      poolModeRetryStatusCodes: '重试状态码',
      poolModeRetryStatusCodesHint: '逗号分隔的上游 HTTP 状态码；池模式下这些状态会触发同账号重试。留空使用默认值：{default}。',
    ...
    settings: {
      ...
      gatewayForwarding: {
        ...
        claudeOAuthSystemPromptInjection: 'Claude OAuth system prompt 注入',
        claudeOAuthSystemPromptInjectionHint: '开启后，对 Anthropic OAuth/Setup Token 请求体注入自定义 system prompt 及其 blocks 配置。',
        claudeOAuthSystemPrompt: 'Claude OAuth system prompt',
        claudeOAuthSystemPromptPlaceholder: '输入要注入的 system prompt',
        claudeOAuthSystemPromptBlocks: 'Claude OAuth system prompt blocks',
        claudeOAuthSystemPromptBlocksPlaceholder: '输入 JSON 格式的 blocks 配置',
      },
      webSearchEmulation: {
        title: 'Web Search 模拟',

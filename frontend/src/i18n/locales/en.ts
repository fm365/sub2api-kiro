export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      poolModeRetryStatusCodesHint: 'Comma-separated upstream HTTP status codes that trigger same-account retries in pool mode. Leave empty to use default: {default}.',
